...
export function SettingsView({ surface, border, textSecondary, textPrimary, accent }: any) {
  return (
    <div style={{ animation: "fadeSlideUp 0.3s ease", maxWidth: 600 }}>
      ...
      <div style={{ background: surface, border: `1px solid ${border}`, borderRadius: 16, padding: 24, marginBottom: 16 }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 16 }}>
          ...
          <select style={{ background: "rgba(17,24,39,0.03)", border: `1px solid ${border}`, borderRadius: 8, padding: "8px 12px", color: textPrimary, outline: "none" }}>
      ...
      <div style={{ background: surface, border: `1px solid ${border}`, borderRadius: 16, padding: 24 }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          ...
          <div style={{ width: 44, height: 24, background: "#111827", borderRadius: 12, position: "relative", cursor: "pointer" }}>
