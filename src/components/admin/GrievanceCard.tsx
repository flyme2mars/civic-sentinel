  ...
  return (
    <div
      ...
      <div style={{ display: "flex", gap: 6, flexWrap: "wrap", marginBottom: 14 }}>
        ...
        {g.socialShared && (
          <span style={{ background: "rgba(17,24,39,0.05)", color: "#111827", border: `1px solid rgba(17,24,39,0.1)`, padding: "3px 8px", borderRadius: 999, fontSize: 10, fontWeight: 700, display: "flex", alignItems: "center", gap: 4 }}>
            <Twitter className="w-3 h-3" /> {g.twitterLikes}
          </span>
        )}
      </div>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 12, fontSize: 11, color: textSecondary }}>
        ...
        <span style={{ overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>{g.address}</span>
